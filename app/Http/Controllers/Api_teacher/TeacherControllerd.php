...
class TeacherControllerd extends BaseController
{
...
public function getTeacherExtraHours(Request $request)
    ...
    public function display_all_my_course()
    {
        ...
        $courses = course::where('teacher_id', $teacher->id)->with(['classs', 'teacher', 'subject'])->get();
        return $courses;
    ...
    public function display_info_course($course_id)
{
    ...
    //     ->first();
    $course = Course::where('id', $course_id)
            ->with(['publish.image', 'classs', 'teacher.user'])
            ->first();
